...
<body class="text-slate-800 antialiased selection:bg-pink-300 selection:text-pink-900 relative bg-grid-pattern">
    ...
    <!-- Navigation -->
    <nav class="glass sticky top-4 z-50 mx-4 md:mx-auto max-w-6xl rounded-[2rem] px-6 py-4 shadow-sm gs-nav">
        <div class="flex justify-between items-center">
            <h1 class="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-500 italic tracking-tight">
        ...
        <div class="container mx-auto max-w-6xl relative z-10">
            <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                ...
                <div class="flex-1 text-center lg:text-left relative z-10">
                    <div class="gs-hero-badge inline-flex items-center gap-2 px-5 py-2 mb-8 text-xs font-bold tracking-widest text-pink-600 uppercase bg-white/80 backdrop-blur-sm rounded-full border border-pink-200 shadow-sm">
                    ...
                    <h2 class="gs-hero-title text-5xl md:text-6xl lg:text-7xl font-black text-slate-800 mb-6 leading-[1.1] tracking-tight">
                        Nonton Premium <br>
                    ...
                    <p class="gs-hero-desc text-slate-600 max-w-xl mx-auto lg:mx-0 mb-10 text-lg font-medium leading-relaxed">
                    ...
                    <div class="gs-hero-btn flex flex-wrap justify-center lg:justify-start gap-4 mb-10">
                        <a href="#katalog" class="px-8 py-4 bg-slate-800 text-white rounded-full font-bold text-lg shadow-xl shadow-slate-800/20 hover:bg-slate-900 hover:-translate-y-1 transition-all duration-300">Lihat Katalog</a>
                        <a href="#cara-order" class="px-8 py-4 bg-white/80 text-slate-700 rounded-full font-bold text-lg shadow-lg shadow-pink-100/50 hover:bg-white hover:-translate-y-1 transition-all duration-300 border border-white">Cara Kerjanya?</a>
                    </div>

                    <!-- Avatars -->
                    <div class="gs-hero-desc flex items-center justify-center lg:justify-start gap-4">
                        <div class="flex -space-x-3">
                            <img class="w-10 h-10 rounded-full border-2 border-white shadow-sm" src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=100&q=80" alt="User">
                            <img class="w-10 h-10 rounded-full border-2 border-white shadow-sm" src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=100&q=80" alt="User">
                            <img class="w-10 h-10 rounded-full border-2 border-white shadow-sm" src="https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=100&q=80" alt="User">
                            <div class="w-10 h-10 rounded-full border-2 border-white shadow-sm bg-pink-100 flex items-center justify-center text-xs font-bold text-pink-600">+10k</div>
                        </div>
                        <div class="text-sm font-semibold text-slate-600">Pelanggan Puas</div>
                    </div>
                </div>
                ...
                <div class="flex-1 relative w-full flex justify-center lg:justify-end gs-hero-img mt-12 lg:mt-0">
                    <div class="relative w-full max-w-[350px] aspect-square flex items-center justify-center">
                        ...
                        <div class="relative w-64 bg-slate-900/90 backdrop-blur-xl p-6 rounded-[2rem] border border-slate-700 shadow-2xl z-20 animate-float" style="animation-duration: 6s;">
                            <div class="flex justify-between items-start mb-6">
                                ...
                                <span class="px-3 py-1 bg-white/10 text-white/80 text-[10px] font-bold rounded-full uppercase tracking-wider">4K UHD</span>
                            </div>
                            <h4 class="text-white font-black text-xl mb-1">Netflix Premium</h4>
                            <p class="text-slate-400 text-sm mb-4">Sharing & Private</p>
                            <div class="w-full bg-slate-800 rounded-full h-2 mb-2">
                                <div class="bg-red-500 h-2 rounded-full w-3/4"></div>
                            </div>
                            <p class="text-[10px] text-slate-500 font-medium">Ready Stock</p>
                        </div>

                        <!-- Top Left Floating Card (Spotify style) -->
                        <div class="absolute -top-8 -left-12 lg:-left-20 w-48 bg-white/95 backdrop-blur-xl p-5 rounded-[2rem] border border-white shadow-xl shadow-pink-100/50 z-10 transform -rotate-12 hover:rotate-0 hover:z-30 transition-all duration-500 animate-float" style="animation-duration: 5s; animation-delay: 1s;">
                            ...
                            <h4 class="text-slate-800 font-black text-lg">Spotify</h4>
                            <p class="text-slate-500 text-[10px] mb-3">Individual / Family</p>
                            <div class="flex items-center gap-1.5">
                                <span class="flex h-2 w-2 relative">
                                    <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-green-400 opacity-75"></span>
                                    <span class="relative inline-flex rounded-full h-2 w-2 bg-green-500"></span>
                                </span>
                                <span class="text-[9px] text-slate-400 font-bold uppercase tracking-wider">Aktif 1 Tahun</span>
                            </div>
                        </div>

                        <!-- Bottom Right Floating Card (Disney style) -->
                        <div class="absolute -bottom-8 -right-8 lg:-right-16 w-48 bg-gradient-to-br from-blue-600 to-blue-800 backdrop-blur-xl p-5 rounded-[2rem] border border-blue-400/50 shadow-xl shadow-blue-900/30 z-30 transform rotate-12 hover:rotate-0 hover:z-40 transition-all duration-500 animate-float" style="animation-duration: 7s; animation-delay: 2s;">
                            <div class="w-12 h-12 bg-white rounded-xl mb-4 flex items-center justify-center text-blue-700 font-black text-2xl shadow-lg shadow-white/20">D+</div>
    ...
    <section id="keunggulan" class="container mx-auto px-4 py-20 relative z-10">
        <div class="glass-card rounded-[3rem] p-10 md:p-16 shadow-2xl shadow-pink-100/40">
            <div class="text-center mb-12 gs-fade-up">
                <h3 class="text-3xl font-black mb-3 text-slate-800">Kenapa Belanja di Bilaa?</h3>
                <p class="text-slate-500 text-lg">Bukan sekadar murah, tapi kualitas dan pelayanan nomor satu.</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="gs-feature-card bg-white/60 p-8 rounded-[2rem] border border-white hover:bg-white transition-colors duration-300 text-center shadow-sm">
                    ...
                    <h4 class="font-bold text-xl mb-3 text-slate-800">Proses Kilat</h4>
                    <p class="text-slate-600 leading-relaxed">Gak pake lama! Akun langsung dikirim 5-15 menit setelah pembayaran dikonfirmasi.</p>
                </div>
                <div class="gs-feature-card bg-white/60 p-8 rounded-[2rem] border border-white hover:bg-white transition-colors duration-300 text-center shadow-sm">
                    ...
                    <h4 class="font-bold text-xl mb-3 text-slate-800">100% Legal & Aman</h4>
                    <p class="text-slate-600 leading-relaxed">Anti hold atau blokir. Semua akun berlangganan secara resmi, dijamin aman dipakai.</p>
                </div>
                <div class="gs-feature-card bg-white/60 p-8 rounded-[2rem] border border-white hover:bg-white transition-colors duration-300 text-center shadow-sm">
                    ...
                    <h4 class="font-bold text-xl mb-3 text-slate-800">Full Garansi</h4>
                    <p class="text-slate-600 leading-relaxed">Ada kendala? Jangan panik, Bilaa siap bantu sampai tuntas sesuai masa garansi kamu!</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="cara-order" class="container mx-auto px-4 py-20 relative z-10">
        <div class="text-center mb-16 gs-fade-up">
            <h3 class="text-4xl font-black mb-3 text-slate-800">Gimana Cara Ordernya?</h3>
            <p class="text-slate-500 text-lg">Gampang banget, cuma butuh 4 langkah simpel!</p>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 relative">
            ...
            <div class="gs-step-card text-center p-8 bg-white/80 backdrop-blur-md rounded-[2.5rem] shadow-xl shadow-pink-50/50 border border-white relative z-10 group hover:-translate-y-2 transition-transform duration-300">
                ...
                <h4 class="font-bold text-lg mb-3 text-slate-800">Pilih Akun</h4>
                <p class="text-slate-600">Pilih aplikasi dan paket durasi yang kamu mau di katalog.</p>
            </div>
            <div class="gs-step-card text-center p-8 bg-white/80 backdrop-blur-md rounded-[2.5rem] shadow-xl shadow-pink-50/50 border border-white relative z-10 group hover:-translate-y-2 transition-transform duration-300">
                ...
                <h4 class="font-bold text-lg mb-3 text-slate-800">Klik Pesan</h4>
                <p class="text-slate-600">Kamu akan diarahkan otomatis ke WhatsApp admin Bilaa.</p>
            </div>
            <div class="gs-step-card text-center p-8 bg-white/80 backdrop-blur-md rounded-[2.5rem] shadow-xl shadow-pink-50/50 border border-white relative z-10 group hover:-translate-y-2 transition-transform duration-300">
                ...
                <h4 class="font-bold text-lg mb-3 text-slate-800">Pembayaran</h4>
                <p class="text-slate-600">Lakukan pembayaran via QRIS, E-Wallet, atau Transfer Bank.</p>
            </div>
            <div class="gs-step-card text-center p-8 bg-white/80 backdrop-blur-md rounded-[2.5rem] shadow-xl shadow-pink-50/50 border border-white relative z-10 group hover:-translate-y-2 transition-transform duration-300">
                ...
                <h4 class="font-bold text-lg mb-3 text-slate-800">Selesai!</h4>
                <p class="text-slate-600">Akun dikirim dan kamu bisa langsung mulai rebahan sambil nonton.</p>
            </div>
        </div>
    </section>
    ...
    <section id="katalog" class="container mx-auto px-4 py-20 relative z-10">
        <div class="text-center mb-12 gs-fade-up">
            <h3 class="text-4xl font-black mb-4 text-slate-800">Katalog Aplikasi</h3>
            <p class="text-slate-500 text-lg mb-10">Pilih aplikasi favoritmu di bawah ini</p>
            ...
            <div class="max-w-2xl mx-auto relative group">
                ...
                <input type="text" id="searchInput" placeholder="Cari aplikasi kesukaanmu..."
                    class="relative w-full pl-14 pr-6 py-5 bg-white/90 backdrop-blur-md border border-pink-100 rounded-full shadow-lg outline-none focus:ring-2 focus:ring-pink-400/50 transition-all text-lg font-medium text-slate-700 placeholder:text-slate-400">
        ...
        <div id="appGrid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            @foreach ($apps as $app)
                <div class="app-card gs-app-card relative h-full group" data-name="{{ strtolower($app->nama) }}">
                    <div class="absolute -inset-0.5 bg-gradient-to-br from-pink-300 to-purple-400 rounded-[2.5rem] blur opacity-0 group-hover:opacity-40 transition duration-500 z-0"></div>
                    
                    <div class="relative bg-white/80 backdrop-blur-xl h-full rounded-[2.5rem] p-8 flex flex-col justify-between border border-white shadow-xl shadow-pink-100/40 z-10 overflow-hidden">
                        <div class="absolute -top-10 -right-10 w-32 h-32 bg-pink-100 rounded-full blur-2xl opacity-50"></div>
                        
                        <div>
                            <div class="flex justify-between items-start mb-8">
                                <div class="w-20 h-20 bg-white p-4 rounded-2xl border border-pink-50 shadow-md group-hover:scale-110 group-hover:-rotate-3 transition-all duration-500 relative z-10 flex items-center justify-center overflow-hidden">
                                    @if ($app->logo)
                            ...
                            <h3 class="text-3xl font-black text-slate-800 mb-2 tracking-tight">{{ $app->nama }}</h3>
                        ...
                        <div class="relative z-10">
                            ...
                            <div class="mb-6">
                                <span class="block text-sm text-slate-500 font-medium mb-1 uppercase tracking-wider">Mulai dari</span>
                                <p class="text-4xl font-black text-slate-800 flex items-baseline gap-1">
                                    Rp {{ number_format($hargaTermurah, 0, ',', '.') }}
                                    <span class="text-base text-slate-400 font-semibold">/paket</span>
                                </p>
                            </div>

                            <a href="{{ route('app.detail', $app->id) }}" class="flex items-center justify-center gap-2 w-full bg-slate-800 text-white py-4 rounded-2xl font-bold text-lg shadow-lg hover:bg-gradient-to-r hover:from-pink-500 hover:to-rose-500 hover:shadow-pink-300 transition-all duration-300 group/btn">
            ...
            <!-- Empty State -->
            <div id="noResults" class="hidden col-span-full text-center py-20 bg-white/60 backdrop-blur-sm rounded-[3rem] border-2 border-dashed border-pink-200">
                ...
                <h3 class="text-3xl font-black text-slate-800 mb-2">Ups! Enggak ketemu...</h3>
                <p class="text-slate-500 text-lg">Coba cari nama aplikasi lain ya sis, mungkin salah ketik.</p>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 relative overflow-hidden">
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="text-center mb-16 gs-fade-up">
                ...
                <p class="text-slate-500 text-lg">Ribuan pelanggan udah buktiin nyamannya belanja di Bilaa's Store.</p>
            </div>
                ...
                <div class="swiper-wrapper">
                    @foreach ($testimonies as $t)
                        <div class="swiper-slide h-auto">
                            <div class="glass-card p-8 md:p-10 rounded-[2.5rem] h-full flex flex-col justify-between relative overflow-hidden group hover:-translate-y-2 transition-transform duration-300">
                                ...
                                <div class="relative z-10">
                                    ...
                                    <p class="text-slate-700 font-medium italic leading-relaxed mb-8 text-lg">
                                        "{{ $t->teks }}"
                                    </p>
                                </div>

                                <div class="flex items-center gap-4 border-t border-pink-100 pt-6">
                                    <div class="w-12 h-12 rounded-full overflow-hidden border-2 border-white shadow-md flex-shrink-0">
                                        <img src="https://i.pravatar.cc/150?u={{ $t->id }}" alt="Avatar" class="w-full h-full object-cover">
                                    </div>
                                    <div>
                                        <h4 class="font-black text-slate-800 text-lg">{{ $t->nama }}</h4>
    ...
    <section id="faq" class="container mx-auto px-4 py-20 max-w-3xl relative z-10">
        <div class="text-center mb-12 gs-fade-up">
            <h3 class="text-4xl font-black mb-4 text-slate-800">Sering Ditanyakan (FAQ)</h3>
            <p class="text-slate-500 text-lg">Masih ragu? Cek pertanyaan yang sering ditanyakan di sini ya!</p>
        </div>
        
        <div class="space-y-4 gs-fade-up">
            <div class="accordion-item bg-white/80 backdrop-blur-sm rounded-[1.5rem] border border-pink-100 overflow-hidden transition-all duration-300">
                <button class="accordion-btn w-full px-6 py-5 text-left flex justify-between items-center focus:outline-none">
                    <span class="font-bold text-lg text-slate-800">Ada garansinya nggak kak?</span>
                ...
                <div class="accordion-content hidden px-6 pb-6 text-slate-500">
            ...
            <div class="accordion-item bg-white/80 backdrop-blur-sm rounded-[1.5rem] border border-pink-100 overflow-hidden transition-all duration-300">
                <button class="accordion-btn w-full px-6 py-5 text-left flex justify-between items-center focus:outline-none">
                    <span class="font-bold text-lg text-slate-800">Berapa lama proses pengirimannya?</span>
                    <svg class="w-6 h-6 text-pink-500 transform transition-transform duration-300 icon" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
                </button>
                <div class="accordion-content hidden px-6 pb-6 text-slate-500">
            ...
            <div class="accordion-item bg-white/80 backdrop-blur-sm rounded-[1.5rem] border border-pink-100 overflow-hidden transition-all duration-300">
                <button class="accordion-btn w-full px-6 py-5 text-left flex justify-between items-center focus:outline-none">
                    <span class="font-bold text-lg text-slate-800">Bisa perpanjang akun pakai email sendiri?</span>
                    <svg class="w-6 h-6 text-pink-500 transform transition-transform duration-300 icon" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
                </button>
                <div class="accordion-content hidden px-6 pb-6 text-slate-500">
    ...
    <!-- Footer -->
    <footer class="mt-12 bg-white/90 backdrop-blur-md border-t border-pink-100 pt-16 pb-8">
        <div class="container mx-auto px-4 text-center">
            <h2 class="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-500 italic tracking-tight mb-4">
                Bilaa's Store
            </h2>
            <p class="text-slate-500 mb-8 max-w-md mx-auto">Nonton premium sepuasnya tanpa bikin dompet nangis. Kualitas resmi, harga merakyat!</p>
            <div class="flex justify-center gap-6 mb-12 text-slate-400">
            ...
            <div class="pt-8 border-t border-pink-50 text-slate-400 text-sm font-medium">
